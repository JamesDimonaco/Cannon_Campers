...
export default function Toast({show, setShow, message, type}) {
  ...
  return (
    <>
      ...
      <div
        aria-live="assertive"
        className="pointer-events-none fixed inset-0 flex items-end px-4 py-6 sm:items-start sm:p-6 mt-8 z-20 "
      >
